...
def _add_new_account_flow(
    ...
    print("\n  -- Why we need these tokens --")
    print("  This program needs two tokens from your browser to pretend")
    print("  to be your browser when talking to Ikariam's servers.")
    print()
    print("  WARNING: If you share these details with anyone you don't")
    print("  trust, they can access your account as if they are sitting")
    print("  at your machine. Share with caution!")
    print()
    print("  This program stores these details in a password-protected")
    print("  file only on your machine — you are the only person with")
    print("  the password. This program will never send or upload the")
    print("  file or its contents to anyone. They are only used to log")
    print("  into Ikariam (and keep you logged in) and to pretend to be")
    print("  your browser.")
    print()
    print("  To find these tokens, follow these instructions:")
    print("    1. Go to your normal browser where you play Ikariam")
    ...
    print("    6. You will see a few 'sessions' entries appear in the")
    print("       Network tab. Click on each one — a new panel will")
    print("       appear with tabs like Headers, Payload, Preview,")
    print("       Response. Only ONE of them will have a Payload tab.")
    print("    7. Click the Payload tab — you will see a list of fields")
    print("       including your email address and password")
    print("    8. Find the 'blackbox' field — it starts with tra:")
    print("       Copy the entire string (ignore the quotes around it)")
    print()
    print("  -- Blackbox Token --")
    print("  Paste the blackbox token you just copied (starts with tra:)")
    print("  Leave blank to skip — it will be fetched automatically during login.")
    blackbox_token = read_input("Blackbox token (leave blank to skip): ")

    print()
    print("  -- GF Token --")
    print("  Now for the GF token. In the same browser where you just")
    print("  logged in, click the Console tab in dev tools (F12).")
    print("  Paste this command into the console:")
    print()
    print("    document.cookie.split(';').forEach(x => {")
    print("      if (x.includes('production')) console.log(x) })")
    print()
    print("  If you haven't done this before, the browser console may")
    print("  tell you pasting needs to be allowed. Simply type:")
    print("    allow pasting")
    print("  Press Enter, then try pasting the command again.")
    print()
    print("  It will show you the token details. Copy the token that")
    print("  starts with gf-token-production=")
